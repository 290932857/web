...
-- Records of t_order
-- ----------------------------
INSERT INTO `t_order` VALUES ('50', 'DD001', '1', '1', '2016-12-01 17:09:58', '2', null, null, null);
INSERT INTO `t_order` VALUES ('51', 'DD002', '1', '2', '2016-12-01 17:25:16', '2', null, null, null);
INSERT INTO `t_order` VALUES ('52', 'DD003', '1', '1', '2016-12-01 17:48:34', '2', null, null, null);

-- ----------------------------
-- Table structure for t_order_dt
-- ----------------------------
DROP TABLE IF EXISTS `t_order_dt`;
...
-- ----------------------------
-- Records of t_order_dt
-- ----------------------------
INSERT INTO `t_order_dt` VALUES ('26', '50', '2', '2');
INSERT INTO `t_order_dt` VALUES ('27', '50', '1', '1');
INSERT INTO `t_order_dt` VALUES ('28', '51', '2', '30');
INSERT INTO `t_order_dt` VALUES ('29', '51', '1', '233');
INSERT INTO `t_order_dt` VALUES ('30', '52', '2', '331');
...
-- ----------------------------
INSERT INTO `t_provider` VALUES ('1', '北京华联', '北京昌平区回龙观20号', '许三多', '01023698742', '01023698742', null, null);
INSERT INTO `t_provider` VALUES ('2', '北京国安', '北京朝阳区北路23号', '王刁刁', '01088956327', '01088956327', null, null);
...
-- Records of t_stock
-- ----------------------------
INSERT INTO `t_stock` VALUES ('5', '50', '1', '2', '1', '2', '2016-12-01 17:24:29');
...
-- ----------------------------
INSERT INTO `t_sys_resources` VALUES ('1', '订单/产品管理', '订单/产品管理', '', '0', '0', null, '1');
INSERT INTO `t_sys_resources` VALUES ('2', '库存管理', '库存管理', 'pages/stock/stock_list.html', '1', '0', null, '2');
INSERT INTO `t_sys_resources` VALUES ('3', '订单管理', '订单管理', 'pages/order/order_list.html', '1', '0', null, '1');
INSERT INTO `t_sys_resources` VALUES ('4', '系统管理', '系统管理', null, '0', '0', null, '1');
INSERT INTO `t_sys_resources` VALUES ('5', '用户管理', '用户管理', 'pages/sync/faile_package.jsp', '4', '0', null, '3');
